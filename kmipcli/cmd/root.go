...
const defaultCfgFileName = "kmipcli.cfg"

// rootCmd represents the base command when called without any subcommands
var rootCmd = &cobra.Command{
	Use:   "kmipcli",
	Short: "Entrust Kmip Tenant Portal CLI",
	Long: `Perform Kmip Tenant operations

Create/Manage Kmip tenant's client certificates and KMIP objects.`,
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&gAccessTokenFile, loginOptionTokenFile, "",
		"Name of the File (with full path) for saving and reusing Access Token "+
			...
			"use this file. If a token file is not specified, default file kmip_token.txt "+
			"is created in kmipcli.data/ under your home or profile directory.")
}

...
func init() {
    ...
    createPolicyCmd.Flags().StringArrayP("local-user", "l", []string{},
                                         "(FOR FUTURE USE ONLY) Local user name of users to be added " +
